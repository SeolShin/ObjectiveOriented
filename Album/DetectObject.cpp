...
void DetectObject::print_string( char *string )
{
  int     i;
...
int DetectObject::draw_exview( double a, double b, double r, double trans[3][4], int xwin, int ywin )
{
    double      vtrans[3][4];
    double      gl_para[16];
    int         i, j;
...
static void DetectObject::draw_camera( double trans[3][4] )
{
/*
    double      gl_para[16];
*/
...
int DetectObject::draw( char *name, double trans[4][4], int xwin, int ywin )
{
    double      gl_para[16];
...
static int  DetectObject::draw_object( char *name, double gl_para[16], int xwin, int ywin )
{
    argDrawMode3D();
    argDraw3dCamera( xwin, ywin );
...
static void DetectObject::setup_light()
{
    static int  mat_f = 1;
...
static void DetectObject::get_trans( double a, double b, double r, double trans[3][4] )
{
    ARMat   *mat;
    double  sa, ca, sb, cb;
    double  x, y, z;
...
static void DetectObject::draw_axis( void )
{
    glPushMatrix();
